<template>
    ...
    <form class="flex items-center" >
        ...
        <div class="relative w-full">
            ...
            <input type="text" v-model="search" id="voice-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-300 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" required>
...
//
//         watch(search, value => {
//             Inertia.get('/post/search', {search:input})
//         })


//initial form used for search, attempting new version above with watch essentially a "filter"
        // function getSearch(){
        //     Inertia.post('/post/search', search)
        // }
        //
...
watch(search, value => {
    Inertia.get('/post/search', { search: value })
})
